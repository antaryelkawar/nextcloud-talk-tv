export default {
  ...
  primaryDark: "#006AA3", // Nextcloud Blue Dark
  primaryLight: "#3395D0", // Lighter accent
  ...
  warning: "#FBBF24",
  error: "#F87171",
  // focusGlow: "rgba(0,130,201,0.6)",

  // === Gradients ===
  blueDepth: "linear-gradient(180deg, rgba(0,130,201,0.9), rgba(10,15,20,0.95))",
